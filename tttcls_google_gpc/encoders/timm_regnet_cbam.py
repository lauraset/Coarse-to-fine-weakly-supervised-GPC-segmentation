...
from timm.models.regnet_cbam import RegNet
...
class RegNetEncoder(RegNet, EncoderMixin):
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        super().load_state_dict(state_dict, strict=False, **kwargs) # add strict false
...
timm_regnet_cbam_encoders = {
    'timm-regnetx_002_cbam': {
